...
Scheme
{
	...
	BaseSettings
	{
		...
		Frame.BgColor					"TransparentBlack"	// CLAUDE: also the spectator top/bottom bar colour (and the spectator menu); in-game windows draw their own panels
		...
		// Hint message colors
		"HintMessageFg"			"255 255 255 255"	// CLAUDE: timer hint box text AND the right-side KeyHintText (HudLayout TextColor is ignored for that)
		"HintMessageBg" 		"0 0 0 60"	// CLAUDE: timer hint box background
	...
	Fonts
	{
		...
		"Default"	// CLAUDE: radio/left menus, spectated player name, spec menu text
		{
			"1"
			{
				"name"		"Verdana"
		...
		CenterPrintText	// CLAUDE: server HudMsg/game_text: jhud and top-left record texts (their colour comes from the server)
		{
		...
		HudHintText	// CLAUDE: timer hint box (HudHintDisplay); HudHintTextSmall = right-side key hint text
		{
			"1"
			{
				"name"		"Verdana"
		...
		HudNumbers	// CLAUDE: health/armor/ammo/money/timer numbers when HudLayout gives no font
		{
			"1"
			{
				"name"  "Counter-Strike" // Cstrike.ttf
